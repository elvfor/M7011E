...
def read_configuration(
    ...
    project_table = asdict.get("TaskManager", {})
    ...
    try:
        ...
        subset = {"TaskManager": project_table, "tool": {"setuptools": setuptools_table}}
...
def expand_configuration(
    ...
    :param str root_dir: Top-level directory for the distribution/TaskManager
...
class _ConfigExpander:
    def __init__(
        ...
        self.project_cfg = config.get("TaskManager", {})
...
class _InvalidFile(UserWarning):
    ...
    DO NOT include the `[TaskManager]` or `[tool.setuptools]` tables in your file.
    \n\n!!
    """
