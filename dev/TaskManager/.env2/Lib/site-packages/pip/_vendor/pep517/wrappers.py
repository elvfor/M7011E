...
class Pep517HookCaller:
    ...
    def prepare_metadata_for_build_wheel(
        ...
        """Prepare a ``*.dist-info`` folder with metadata for this TaskManager.
    ...
    def build_wheel(
        ...
        """Build a wheel from this TaskManager.
    ...
    def build_editable(
            self, wheel_directory, config_settings=None,
            metadata_directory=None):
        """Build an editable wheel from this TaskManager.
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        """Build an sdist from this TaskManager.
