...
class InstallRequirement:
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the TaskManager metadata
        ...
        # The PEP 517 backend we should use to build the TaskManager
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            ...
            "produced metadata for TaskManager name %s. Fix your "
            "#egg=%s fragments.",
            self.name,
            metadata_name,
            self.name,
    ...
    def prepare_metadata(self) -> None:
        """Ensure that TaskManager metadata is available.
